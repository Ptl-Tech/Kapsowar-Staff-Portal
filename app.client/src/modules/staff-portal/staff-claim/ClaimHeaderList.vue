<template>
    <ListPageTemplate ref="tpList" :pageProps="this.pageProps" :actionsProps="this.actionsProps" @OnFetchData="OnFetchData($event)">
        <template #navigationTabs>
            <MenuTabs>
                <MenuLink linkTo="/ess/staff-claim/list?status=Open">Open <span class="hidden sm:flex pl-1">Requests</span></MenuLink>
                <MenuLink linkTo="/ess/staff-claim/list?status=Pending Approval">Pending <span class="hidden sm:flex pl-1">Requests</span></MenuLink>
                <MenuLink linkTo="/ess/staff-claim/list?status=Released">Approved <span class="hidden sm:flex pl-1">Requests</span></MenuLink>
            </MenuTabs>
        </template>
        <template #thead>
            <WTh>No.</WTh>
