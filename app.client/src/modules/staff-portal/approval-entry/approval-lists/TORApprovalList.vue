    ...
    export default {
        ...
        methods: {
            ...
            FnGetRecordLink(recApprovalEntry) {
                var link = "";
                //tor
                if (recApprovalEntry.Table_ID == 52018806 && recApprovalEntry.Details.includes("Terms")) {
                    link = "/ess/approval-entry/"+this.status+"/TOR/view/" + recApprovalEntry.Document_No + "/" + recApprovalEntry.Entry_No + "/TOR";
                }
                return link;
            }
        },
