    ...
    export default {
        ...
        data(){
            return {
                records:[],
                pageProps: {
                    title: 'M&E Branch Report Approvals List',
                    pageType:"list",
                    pKey: 'No',
        ...
        methods: {
            ...
            FnGetRecordLink(recApprovalEntry) {
                var link = "";
                //MEBranch
                if (recApprovalEntry.Table_ID == 52018798 && recApprovalEntry.Details.includes("Branch")) {
                    link = "/ess/approval-entry/"+this.status+"/ME-branch-report/view/" + recApprovalEntry.Document_No + "/" + recApprovalEntry.Entry_No + "/ME-branch-report/step-1";
                }
                return link;
            }
        },
