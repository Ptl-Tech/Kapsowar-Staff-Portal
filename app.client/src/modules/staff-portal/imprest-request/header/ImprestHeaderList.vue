<template>
    <ListPageTemplate ref="tpList" :pageProps="this.pageProps" :actionsProps="this.actionsProps" @OnFetchData="OnFetchData($event)">
        ...
        <template v-for="(record,index) in records" #[`tbody-${index}`]>
            ...
            <WTd>{{record.Employee_No}}</WTd>
            <WTd>{{record.Total_Net_Amount}}</WTd>
            <WTd>
    ...
    export default {
        ...
        data(){
            return {
                ...
                actionsProps: { isNew: true,isNewCaption:"New Imprest", isEdit: true, isDelete: false, isFilter: true, isExport: true},
            }
        },
        methods: {
