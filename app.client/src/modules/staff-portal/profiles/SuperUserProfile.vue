<template>
    <div>
        <Sidebar>
            <sidebar-link to="/dashboard" :active="this.$route.path == '/dashboard'?true:false" :isLast="true" class="border-b border-gray-500"><Squares2X2Icon class="iconSmall" /> Dashboard</sidebar-link>
            <!---->
