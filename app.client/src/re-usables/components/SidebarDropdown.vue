<template>
    <div :class="['relative py-0.5 border-t border-gray-500',!isLast? 'border-b border-gray-500':'']">
        ...
        <div @click="open = ! open" :class="['flex items-center justify-between cursor-pointer pr-2 pl-2 py-1 text-xs leading-5 text-white gap-1 font-medium hover:bg-theme-1 hover:rounded-md']">
        ...
        <transition
            ...
            <div v-show="open"
                    ...
                    style="display: none; padding-left:18px !important; width:100% !important"
                    >
