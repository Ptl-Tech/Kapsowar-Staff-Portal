<template>
  <header>
    ...
    <nav class="bg-gray-200x bg-theme-1 fixed w-full z-50 top-0 shadow-lg h:10 block items-center">
            ...
            <dropdown class="">
              <template #caption>
                ...
                <div class="flex items-center">
                  ...
                  <span><img src="/images/profile-avatar.png" class="h-6 md:h-7 w-6 md:w-7 rounded-full border border-gray-600 inline-block" alt="client logo"></span>
                </div>
                <!--</div>-->
              </template>
              <template #content>
