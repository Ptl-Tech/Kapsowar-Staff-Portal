        ...
        children: [
            ...
            //approval-entry
            {
                ...
                children: [
                    ...
                    { path: ':status/leave/:action/:no/:entryNo/:docType', component: () => import('@/modules/staff-portal/leave-application/LeaveForm.vue') },
             ...
             */
            //leave
            { path: 'leave/list', name: "LeaveList", component: () => import('@/modules/staff-portal/leave-application/LeaveList.vue'), },
            { path: 'leave/form/:action/:no', component: () => import('@/modules/staff-portal/leave-application/LeaveForm.vue'), },
            //leave-recall
            { path: 'leave-recall/list', name: "LeaveRecallList", component: () => import('@/modules/staff-portal/leave-recall/RecallList.vue'), },
            { path: 'leave-recall/form/:action/:no', component: () => import('@/modules/staff-portal/leave-recall/RecallForm.vue'), },
            {
                path: 'reports',
                meta: { requiresAuth: true },
                children: [
