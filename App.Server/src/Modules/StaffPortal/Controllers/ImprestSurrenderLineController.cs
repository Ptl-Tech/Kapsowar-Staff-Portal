...
namespace App.Server.Modules.HMIS.Controllers
{
    ...
    public class ImprestSurrenderLineController : ControllerBase
    {
        [HttpGet] 
        public IActionResult Index(string parentId)
        {
            try
            {
                ...
                else
                {
                    ...
                    QyImprestSurrenderLines ModelInstance = new QyImprestSurrenderLines();
        ...
        [HttpPost]
        public IActionResult Store([FromBody] ImprestSurrenderLine obj)
        {
            try
            {
                ...
                //
                var result = GV.WSclient.CuStaffWebportal(HttpContext).FnImprestSurrenderLineAsync(JsonSerializer.Serialize(obj)).Result;
