    ...
    public class ImprestRequestLineController : ControllerBase
    {
        ...
        public IActionResult Index(string parentId)
        {
            try
            {
                ...
                response.header = GV.WSclient.ODATAClient().QyImprestHeaders
                    .Where(obj => obj.No == parentId)
                    .FirstOrDefault();
                var baseQuery = GV.WSclient.ODATAClient().QyImprestLines.AsQueryable();
        ...
        public IActionResult GetFormData(string myAction, string parentId, int recId)
        {
            try
            {
                ...
                if (myAction != "create")
                {
                    response.formData = GV.WSclient.ODATAClient().QyImprestLines
