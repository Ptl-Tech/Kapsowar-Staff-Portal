...
namespace App.Server.src.Modules.ESS.Controllers
{
    ...
    public class StaffNextOfKinController : ControllerBase
    {
        [HttpGet]
        public IActionResult index(string type)
        {
            try
            {
                ...
                var baseQuery = GV.WSclient.ODATAClient(HttpContext).QyStaffNextOfKin
                    .Where(obj => obj.Patient_No == GeneralController.SessionUser(HttpContext).userNo)
                    .AsQueryable();
                ...
                else
                {
                    ...
                    QyStaffNextOfKin ModelInstance = new QyStaffNextOfKin();
