...
namespace App.Server.Modules.HMIS.Controllers
{
    ...
    public class StaffClaimLineController : ControllerBase
    {
        [HttpGet] 
        public IActionResult Index(string parentId)
        {
            try
            {
                ...
                else
                {
                    ...
                    QyStaffClaimLines ModelInstance = new QyStaffClaimLines();
        ...
        [HttpPost]
        public IActionResult Store([FromBody] StaffClaimLine obj)
        {
            try
            {
                ...
                //
                var result = GV.WSclient.CuStaffWebportal(HttpContext).FnStaffClaimLineAsync(JsonSerializer.Serialize(obj)).Result;
        ...
        [HttpPost]
        public IActionResult Delete([FromBody] DeleteStaffClaimLine obj)
        {
            try
            {
                obj.staffNo = GeneralController.SessionUser(HttpContext).userNo;
